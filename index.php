...
<body>
    <div class="container-fluid h-100 bg-image" style="background-image: url('img/hero.jpg'); background-size: cover; background-position: center;">
        <div class="row h-100 justify-content-center align-items-center">
          ...
          <section id="ai-art" class="service-section">
            <h3>AI Art Generation</h3>
            <p>Explore the limitless possibilities with our state-of-the-art AI tools to create unique digital artwork.</p>
            <!-- Interactive AI art generation demo, gallery of examples -->
        </section>

        <!-- Upscaling Section -->
        <section id="upscaling" class="service-section">
            <h3>Upscaling</h3>
            <p>Enhance your images with advanced AI algorithms for superior resolution and quality.</p>
            <!-- Image comparison slider, before-and-after examples -->
        </section>

        <!-- Branding and Marketing Section -->
        <section id="branding-marketing" class="service-section">
            <h3>Branding and Marketing</h3>
            <p>Craft a cohesive brand identity encompassing logo design, marketing materials, and digital presence.</p>
            <!-- Portfolio of branding projects, client testimonials -->
        </section>

        <!-- Web Design Section -->
        <section id="web-design" class="service-section">
            <h3>Web Design</h3>
            <p>Custom web design services offering user-friendly, responsive, and SEO-optimized websites.</p>
            <!-- Display of responsive website designs, features highlight -->
        </section>

        <!-- Photography Services Section -->
        <section id="photography" class="service-section">
            <h3>Photography Services</h3>
            <p>Professional photography for events, products, and marketing campaigns.</p>
            <!-- Gallery of photography work, service packages -->
        </section>

        <!-- AI Portrait Printing Section -->
        <section id="ai-portrait-printing" class="service-section">
            <h3>AI Portrait Printing</h3>
            <p>Specialized printing services turning AI-generated portraits into high-quality prints.</p>
            <!-- Examples of AI portraits, printing options -->
        </section>

        <!-- 3D Design and Printing Section -->
        <section id="3d-design-printing" class="service-section">
            <h3>3D Design and Printing</h3>
            <p>Create 3D models for various applications, including prototypes, merchandise, and art pieces.</p>
            <!-- 3D model showcase, printing process explanation -->
        </section>
